...
A continuación se muestra cómo crear paso a paso un nuevo proyecto con JS, agregando una clase y una prueba de unidad.

Considera que todo proyecto nuevo necesita de:
1. Conjunto de folders y archivos para organizar el código.
2. Versionamiento con git.
3. Puede incluir dependencias.
4. Todo proyecto lleva PRUEBAS DE UNIDAD.
...
Con esto indicamos que al realizar el comando `npm test` en realidad estaremos ejecutando con node el script `./node_modules/jest/bin/jest`. CUIDADO: Esto puede variar según el sistema operativo, en este caso se uso Windows.
